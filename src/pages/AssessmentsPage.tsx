  ...
  return (
    <div>
      <div className="max-w-2xl">
        <p className="eyebrow">Understand your living style</p>
        <h1 className="mt-2 font-[var(--font-display)] text-4xl font-extrabold tracking-tight">
          Small questions. Better matches.
        </h1>
        <p className="mt-3 leading-7 text-[#71807b]">
          Your answers help us find people whose rhythms, communication and idea
          of home complement yours.
        </p>
      </div>
      <div className="mt-8 rounded-3xl bg-[#174f3f] p-7 text-white sm:p-9">
        <div className="grid gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
          <div className="flex gap-5">
            <span className="hidden size-14 shrink-0 place-items-center rounded-2xl bg-white/10 sm:grid">
              <BrainCircuit className="text-[#f3c568]" />
            </span>
            <div>
              <p className="text-xs font-extrabold uppercase tracking-[.17em] text-[#9ed5c2]">
                Why it matters
              </p>
              <h2 className="mt-2 font-[var(--font-display)] text-2xl font-extrabold">
                Chemistry is more than shared rent.
              </h2>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-white/65">
                We turn your answers into compatible patterns — not labels. Your
      ...
      <div className="mt-8">
        {tests.length === 0 ? (
          <EmptyState
            ...
            body="There aren't any assessments published yet. Check back soon or ask an admin to add questions to a test definition."
          />
        ) : (
